    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-6">
        ...
        <div className="relative overflow-hidden">
          <img src="/route.png" alt="route" className="w-full h-full object-cover" />
      ...
      <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-6 overflow-x-auto">
        <h3 className="text-sm font-semibold mb-3">Route Performance Details</h3>
          ...
          <tbody>
            {routes.map((r, idx) => (
              ...
              >
                ...
                <td className="py-3">
                  <span
                    className={`px-3 py-1 rounded-full text-[11px] font-semibold ${r.performance === "EXCELLENT"
